...
const products = [
    { 
        ...
        prices: { "صغير": 5, "وسط": 7, "كبير": 10, "1 لتر": 17, "1.5 لتر": 23 }
    },
    { 
        id: 2, name: "اقوى طاقة", desc: "", icon: "🥤", category: "مشروبات",
        prices: { "صغير": 5, "وسط": 7, "كبير": 10, "1 لتر": 17, "1.5 لتر": 23 }
    },
    { 
        id: 3, name: "المصحصح", desc: "", icon: "🥤", category: "مشروبات",
        prices: { "صغير": 5, "وسط": 7, "كبير": 10, "1 لتر": 17, "1.5 لتر": 23 }
    },
    { 
     ...
     { 
        id: 9, name: "أصفهاني", desc: "", icon: "🍹", category: "فواكه",
        prices: { "صغير": 5, "وسط": 7, "كبير": 10, "1 لتر": 17, "1.5 لتر": 23 }
    },
     { 
     ...
     { 
        ...
        prices: { "صغير": 7, "وسط": 10, "كبير": 12, "1 لتر": 22, "1.5 لتر": 28 }
    },
     { 
     ...
     { 
        id: 23, name: "ايسكريم", desc: "", icon: "🍦", category: "مشروبات",
        prices: { "صغير": 5, "وسط": 7, "كبير": 10, "1 لتر": 17, "1.5 لتر": 23 }
    },
     { 
     ...
     { 
        id: 27, name: "رمان و ايسكريم", desc: "", icon: "🍦", category: "فواكه",
        prices: { "صغير": 5, "وسط": 7, "كبير": 10, "1 لتر": 17, "1.5 لتر": 23 }
    },
     { 
    ...
    { 
        ...
        prices: { "صغير": 9, "وسط": 13, "كبير": 18, "1 لتر": 28, "1.5 لتر": 38 }
    },
     { 
     ...
     { 
        id: 112, name: "كوكتيل عدني", desc: "", icon: "🍹", category: "فواكه",
        prices: { "صغير": 5, "وسط": 7, "كبير": 10, "1 لتر": 17, "1.5 لتر": 23 }
    },
     { 
...
const sizeLabels = ["صغير", "وسط", "كبير", "1 لتر", "1.5 لتر"];
